import {
  Text, ScrollArea, Badge, Card, Group,
  Stack, Title, Loader, Center, ActionIcon, Tooltip
} from "@mantine/core";
  ...
  return (
    <Stack p="xl" maw={800} mx="auto">
      <Group justify="space-between">
        ...
        <Text size="sm" c="dimmed">{reports?.length ?? 0} total</Text>
      </Group>
          ...
          {reports?.map((report) => (
            ...
            >
              <Group justify="space-between" mb={6}>
                <Text size="sm" fw={600}>{report.title}</Text>
                <Group gap="xs">
              ...
              <Group gap="lg">
                <Group gap={4}>
                  <TagIcon  size={12} color="gray" />
                  <Text size="xs" c="dimmed">{report.category}</Text>
                </Group>
                <Group gap={4}>
                  <MapPinIcon  size={12} color="gray" />
                  <Text size="xs" c="dimmed">{report.lat.toFixed(4)}, {report.lng.toFixed(4)}</Text>
                </Group>
                <Group gap={4}>
